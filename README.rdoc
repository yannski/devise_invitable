!!! WARNING !!! Please don't use this branch ("edge") directly, instead, use the v0.6.5.1[http://github.com/rymai/devise_invitable/tree/v0.6.5.1] tag or the master[http://github.com/rymai/devise_invitable/tree/master]. This branch will be removed as soon as Rails 3.0 will be released !!! WARNING !!!
...
=== Rails 3.0.0.rc and Devise 1.1.1

Use version 0.6.5.1 (or "master" branch), add in your Gemfile:

  gem "devise",           ">= 1.1.1"
  gem "devise_invitable", :git => "git://github.com/rymai/devise_invitable.git", :tag => "v0.6.5.1"
  # or
  gem "devise_invitable", :git => "git://github.com/rymai/devise_invitable.git"

=== Rails 3.0.0.beta4 and Devise 1.1.rc2

Use the "rails3beta4" branch, add in your Gemfile:

  gem "devise",           "1.1.rc2"
  gem "devise_invitable", :git => "git://github.com/rymai/devise_invitable.git", :branch => "rails3beta4"

!!! WARNING !!! This branch will be removed as soon as Rails 3.0 will be released !!! WARNING !!!
