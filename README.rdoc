...
Add in your Gemfile:
  ...
  gem "devise",           "1.1.rc2"
  gem "devise_invitable", :git => "git://github.com/rymai/devise_invitable.git", :tag => "v0.6.1"    # last "stable" release and Rails 3.0.0.beta4 compatible
  # or
  gem "devise_invitable", :git => "git://github.com/rymai/devise_invitable.git", :branch => "rails3" # most up to date and Rails 3.0.0.beta4 compatible

This will use the rails3[http://github.com/rymai/devise_invitable/tree/rails3] branch of this fork.
